...
void Game::DrawGame()
{
    Color limiteColor = Color::Red;
    Color obstaculoColor = Color::Yellow;
    ...
    sf::RectangleShape obstaculoShape(sf::Vector2f(20, 5));
    obstaculoShape.setFillColor(obstaculoColor);
    obstaculoShape.setPosition(obstaculoBody->GetPosition().x-10,obstaculoBody->GetPosition().y-2.5);
    wnd->draw(obstaculoShape);

    sf::RectangleShape obstaculoShape1(sf::Vector2f(20, 5));
    obstaculoShape1.setFillColor(obstaculoColor);
    obstaculoShape1.setPosition(obstaculoBody1->GetPosition().x - 10, obstaculoBody1->GetPosition().y - 2.5);
    wnd->draw(obstaculoShape1);

    sf::RectangleShape obstaculoShape2(sf::Vector2f(20, 5));
    obstaculoShape2.setFillColor(obstaculoColor);
    obstaculoShape2.setPosition(obstaculoBody2->GetPosition().x - 10, obstaculoBody2->GetPosition().y - 2.5);
    wnd->draw(obstaculoShape2);
...
void Game::InitPhysics()
{
    ...
    obstaculoBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 20, 5);
    obstaculoBody->SetTransform(b2Vec2(50.0f, 30.0f),0.0f);

    obstaculoBody1 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 20, 5);
    obstaculoBody1->SetTransform(b2Vec2(20.0f, 50.0f), 0.0f);

    obstaculoBody2 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 20, 5);
    obstaculoBody2->SetTransform(b2Vec2(80.0f, 80.0f), 0.0f);
